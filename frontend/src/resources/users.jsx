...
export const UserList = () => (
    ...
    >
        ...
        >
            <TextField source="id" label="ID" sortable={false} sx={{ width: '60px' }} />
            <TextField source="username" label="사용자명" sx={{ width: '120px' }} />
            <EmailField source="email" label="이메일" sx={{ width: '280px' }} />
            <TextField source="full_name" label="이름" sx={{ width: '200px' }} />
            <ReferenceField source="department_id" reference="departments" label="부서" link="show" sx={{ width: '160px' }}>
                <TextField source="name" />
            </ReferenceField>
            <GPTAccessField label="GPT 접근" sx={{ width: '70px' }} />
            <BooleanField source="is_active" label="활성" sx={{ width: '60px' }} />
            <DateField source="created_at" label="생성일" showTime sx={{ width: '170px' }} />
            <ShowButton label="상세" sx={{ width: '70px' }} />
            <EditButton label="수정" sx={{ width: '70px' }} />
            <DeleteButton label="삭제" sx={{ width: '70px' }} />
        </Datagrid>
    </List>
);
