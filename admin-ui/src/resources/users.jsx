...
export const UserList = () => (
    ...
    >
        ...
        >
            <TextField source="id" label="ID" sortable={false} sx={{ width: '60px !important', minWidth: '60px', maxWidth: '60px' }} />
            <TextField source="username" label="사용자명" sx={{ width: '120px !important', minWidth: '120px', maxWidth: '120px' }} />
            <EmailField source="email" label="이메일" sx={{ width: '280px !important', minWidth: '280px', maxWidth: '280px' }} />
            <TextField source="full_name" label="이름" sx={{ width: '150px !important', minWidth: '150px', maxWidth: '150px' }} />
            <ReferenceField source="department_id" reference="departments" label="부서" link="show" sx={{ width: '200px !important', minWidth: '200px', maxWidth: '200px' }}>
                <TextField source="name" />
            </ReferenceField>
            <GPTAccessField label="GPT 접근" sx={{ width: '100px !important', minWidth: '100px', maxWidth: '100px' }} />
            <BooleanField source="is_active" label="활성" sx={{ width: '80px !important', minWidth: '80px', maxWidth: '80px' }} />
            <DateField source="created_at" label="생성일" showTime sx={{ width: '170px !important', minWidth: '170px', maxWidth: '170px' }} />
            <ShowButton label="상세" sx={{ width: '80px !important', minWidth: '80px', maxWidth: '80px' }} />
            <EditButton label="수정" sx={{ width: '80px !important', minWidth: '80px', maxWidth: '80px' }} />
            <DeleteButton label="삭제" sx={{ width: '80px !important', minWidth: '80px', maxWidth: '80px' }} />
        </Datagrid>
    </List>
);
