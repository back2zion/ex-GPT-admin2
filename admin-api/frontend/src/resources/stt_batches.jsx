...
export const STTBatchList = () => (
    ...
    >
        ...
        >
            ...
            <TextField source="name" label="배치 이름" sx={{ width: '200px' }} />
            <StatusField source="status" label="상태" sx={{ width: '100px' }} />
            <PriorityField source="priority" label="우선순위" sx={{ width: '80px' }} />
            ...
            >
                ...
                <Box sx={{ px: 2 }}>
                    ...
                    <TextInput
                        ...
                        helperText="예: *.mp3 (MP3만), *.wav (WAV만), *.* (모든 파일)"
                        sx={{
                            '& .MuiInputBase-root': {
                                fontFamily: 'monospace',
                            },
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12} sm={6}>
                            <SelectInput
                                ...
                                defaultValue="normal"
                                fullWidth
                                helperText="높은 우선순위 작업이 먼저 처리됩니다"
                            />
                        </Grid>
                    </Grid>
