...
const CoreUIMenu = () => {
    ...
    return (
        ...
        >
            ...
            {/* Fine-tuning MLOps (Expandable) - 신규 */}
            <ListItem disablePadding>
                <ListItemButton
                    onClick={() => handleExpandClick('finetuningMLOps')}
                    sx={{
                        ...menuItemStyle(false),
                        borderLeft: '4px solid transparent',
                    }}
                >
                    ...
                    {open && (
                        <>
                            <ListItemText primary="Fine-tuning MLOps" />
                            {expandedMenus.finetuningMLOps ? <ExpandLess /> : <ExpandMore />}
                        </>
                    )}
                </ListItemButton>
            </ListItem>

            {/* Nested Fine-tuning MLOps Menu */}
            <Collapse in={expandedMenus.finetuningMLOps && open} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                    <ListItemButton
                        sx={{
                    ...
                    <ListItemButton
                        sx={{
                            ...menuItemStyle(isActive('/ab_testing')),
                            pl: 6,
                        }}
                        onClick={() => handleMenuClick('/ab_testing')}
                    >
                        <ListItemIcon sx={{ ...iconStyle(isActive('/ab_testing')), minWidth: 30 }}>
