...
@Schema(description = "L-039: 단일 파일 삭제 정보 갱신 응답 DTO")
public class SingleFileDeleteInfoResponseDto {
    ...
    @Schema(description = "처리 시간 (밀리초)", example = "800")
    private Long processingTime;

    @Schema(description = "업데이트된 파일 개수", example = "1")
    ...
    public String toString() {
        return "SingleFileDeleteInfoResponseDto{" +
                "cnvsIdtId='" + cnvsIdtId + '\'' +
                ", fileUid='" + fileUid + '\'' +
                ", txnNm='" + txnNm + '\'' +
                ", cnt=" + cnt +
